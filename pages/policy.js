...
const PolicyPage = () => {
	return (
		<div className="min-h-screen bg-black/95 text-zinc-50">
			...
			<section className="policy-content py-40">
				<div className="max-w-5xl mx-auto px-4">
					...
					<div className="space-y-8 text-zinc-300">
						...
						<ul className="list-disc list-inside space-y-2 ml-4">
							...
							<li>
								<p>
									...
									"We", "Us" or "Our" in this Agreement) refers to Agency
									Website Template.
								</p>
							</li>
							<li>
							...
							<li>
								<p>
									<strong>Website</strong> refers to Agency Website Template,
									accessible from{" "}
									<a
										href="https://agency-website-template.vercel.app/"
										rel="external nofollow noopener"
										target="_blank"
										className="text-orange-400 hover:underline"
									>
										https://agency-website-template.vercel.app/
									</a>
								</p>
							</li>
							<li>
						...
						<h4 className="text-xl font-semibold text-white mt-5 mb-2">
							Personal Data
						</h4>
						<p>
						...
						<p>
							...
							<a
								href="https://www.freeprivacypolicy.com/blog/privacy-policy-vs-cookies-policy/"
								target="_blank"
								className="text-orange-400 hover:underline"
							>
						...
						<h3 className="2xl font-semibold text-white mt-6 mb-3">
